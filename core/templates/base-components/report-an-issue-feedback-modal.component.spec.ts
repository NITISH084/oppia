...
describe('ReportAnIssueFeedbackModalComponent', () => {
  let fixture: ComponentFixture<ReportAnIssueFeedbackModalComponent>;
  let component: ReportAnIssueFeedbackModalComponent;
  ...
  const createComponent = (): void => {
    fixture = TestBed.createComponent(ReportAnIssueFeedbackModalComponent);
  ...
  it('should be able to select category chips', () => {
    createComponent();
    component.selectCategory('broken_layout_or_image');
    expect(component.category).toEqual('broken_layout_or_image');

    component.selectCategory('typo');
    expect(component.category).toEqual('typo');

    component.selectCategory('confusing_or_incorrect_answer');
    expect(component.category).toEqual('confusing_or_incorrect_answer');

    component.selectCategory('other_or_not_sure');
    expect(component.category).toEqual('other_or_not_sure');
  });
  ...
  it('should reset form on destroy', fakeAsync(() => {
    ...
    flushMicrotasks();
    component.reportMessage = 'Feedback';
    component.category = 'broken_layout_or_image';
    component.screenshotFilename = 'screenshot.png';
    component.includeTechnicalLogs = false;
    component.screenshotPreviewDataUrl = 'data:image/png;base64,image';
    ...
    expect(component.category).toBe(null);
    expect(component.screenshotFilename).toBeNull();
