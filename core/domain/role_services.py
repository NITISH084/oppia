...
ACTION_ACCESS_WEB_RELEASE_COORDINATOR_PAGE = (
    'ACCESS_WEB_RELEASE_COORDINATOR_PAGE'
)
...
ACTION_ACCESS_ANDROID_RELEASE_COORDINATOR_PAGE = (
    'ACCESS_ANDROID_RELEASE_COORDINATOR_PAGE'
)
...
HUMAN_READABLE_ROLES = {
    ...
    feconf.ROLE_ID_WEB_RELEASE_COORDINATOR: 'web release coordinator',
