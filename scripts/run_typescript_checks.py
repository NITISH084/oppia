...
TS_STRICT_EXCLUDE_PATHS = [
    ...
    'core/templates/pages/web-release-coordinator-page/features-tab/features-tab.component.spec.ts',
    'core/templates/pages/web-release-coordinator-page/release-coordinator-page.component.spec.ts',
